...
.PHONY: help install uninstall check bootstrap lint clean bench health deps brewsync install-% uninstall-%
...
deps:
	@brew deps --tree stow bat eza fzf ripgrep zoxide 2>/dev/null || echo "Homebrewが必要です"
