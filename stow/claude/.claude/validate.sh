...
command -v black &>/dev/null && ok "black (Python)" || warn "black 未インストール"
command -v rustfmt &>/dev/null && ok "rustfmt (Rust)" || warn "rustfmt 未インストール"
command -v gofmt &>/dev/null && ok "gofmt (Go)" || warn "gofmt 未インストール"
