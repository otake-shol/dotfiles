# Generated by Powerlevel10k configuration wizard on 2023-02-23 at 21:37 JST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # command_execution_time  # core.zshのカスタム表示（色+音通知付き）に一本化
    background_jobs         # presence of background jobs
    direnv                  # direnv status (https://direnv.net/)
    asdf                    # asdf version manager (https://github.com/asdf-vm/asdf)
    virtualenv              # python virtual environment (https://docs.python.org/3/library/venv.html)
    # --- 以下はasdfで統一のため無効化 ---
    # anaconda pyenv goenv nodenv nvm nodeenv rbenv rvm fvm
    # luaenv jenv plenv perlbrew phpenv scalaenv haskell_stack
  ...
  # DOTFILES: 紫（設定ファイル）
  typeset -g POWERLEVEL9K_DIR_DOTFILES_BACKGROUND=99
  typeset -g POWERLEVEL9K_DIR_DOTFILES_FOREGROUND=255
  typeset -g POWERLEVEL9K_DIR_DOTFILES_SHORTENED_FOREGROUND=250
  typeset -g POWERLEVEL9K_DIR_DOTFILES_ANCHOR_FOREGROUND=255
  typeset -g POWERLEVEL9K_DIR_DOTFILES_VISUAL_IDENTIFIER_EXPANSION='󰒓'

  # PROJECTS: 青（開発作業）
  typeset -g POWERLEVEL9K_DIR_PROJECTS_BACKGROUND=33
  typeset -g POWERLEVEL9K_DIR_PROJECTS_FOREGROUND=255
  typeset -g POWERLEVEL9K_DIR_PROJECTS_SHORTENED_FOREGROUND=250
  typeset -g POWERLEVEL9K_DIR_PROJECTS_ANCHOR_FOREGROUND=255
  typeset -g POWERLEVEL9K_DIR_PROJECTS_VISUAL_IDENTIFIER_EXPANSION='󰲋'

  # DOWNLOADS: オレンジ（一時的）
  typeset -g POWERLEVEL9K_DIR_DOWNLOADS_BACKGROUND=208
  typeset -g POWERLEVEL9K_DIR_DOWNLOADS_FOREGROUND=0
  typeset -g POWERLEVEL9K_DIR_DOWNLOADS_SHORTENED_FOREGROUND=0
  typeset -g POWERLEVEL9K_DIR_DOWNLOADS_ANCHOR_FOREGROUND=0
  typeset -g POWERLEVEL9K_DIR_DOWNLOADS_VISUAL_IDENTIFIER_EXPANSION='󰇚'

  # TMP: 赤（注意）
  typeset -g POWERLEVEL9K_DIR_TMP_BACKGROUND=196
  typeset -g POWERLEVEL9K_DIR_TMP_FOREGROUND=255
  typeset -g POWERLEVEL9K_DIR_TMP_SHORTENED_FOREGROUND=250
  typeset -g POWERLEVEL9K_DIR_TMP_ANCHOR_FOREGROUND=255
  typeset -g POWERLEVEL9K_DIR_TMP_VISUAL_IDENTIFIER_EXPANSION='󰃨'

  # CONFIG: シアン（設定）
  typeset -g POWERLEVEL9K_DIR_CONFIG_BACKGROUND=37
  typeset -g POWERLEVEL9K_DIR_CONFIG_FOREGROUND=255
  typeset -g POWERLEVEL9K_DIR_CONFIG_SHORTENED_FOREGROUND=250
  typeset -g POWERLEVEL9K_DIR_CONFIG_ANCHOR_FOREGROUND=255
  typeset -g POWERLEVEL9K_DIR_CONFIG_VISUAL_IDENTIFIER_EXPANSION='󰒓'
  ...
  # Custom icon for charging state
