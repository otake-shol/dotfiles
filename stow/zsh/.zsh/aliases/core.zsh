...
alias cdef="claude --permission-mode default"             # 通常確認モード
alias cauto="claude --permission-mode auto"               # 自動実行モード
alias cplan="claude --permission-mode plan"               # 計画モード
alias cyolo="claude --permission-mode bypassPermissions"  # 権限確認スキップ（要注意）
